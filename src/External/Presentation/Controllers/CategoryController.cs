...
public class CategoryController : ControllerBase
{
    ...
    {
        var attributes = await _categoryAttributeService.GetCategoryAttributeDefinitionsAsync(categoryId);
    ...
    {
        var categoryAttribute = await _categoryAttributeService.AssignCategoryAttributeDefinitionAsync(categoryId, request);
        return CreatedAtAction(nameof(GetCategoryAttributeDefinitions), new { categoryId }, categoryAttribute);
    }
    ...
    {
        var categoryAttribute = await _categoryAttributeService.UpdateCategoryAttributeDefinitionAsync(categoryId, id, request);
    ...
    {
        await _categoryAttributeService.RemoveCategoryAttributeDefinitionAsync(categoryId, id);
        return NoContent();
    }
